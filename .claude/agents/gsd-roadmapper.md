...
Reference full template: `C:/motokey-api/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/motokey-api/.claude/get-shit-done/templates/state.md`.
