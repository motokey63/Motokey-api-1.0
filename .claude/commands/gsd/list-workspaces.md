...
<execution_context>
@C:/motokey-api/.claude/get-shit-done/workflows/list-workspaces.md
@C:/motokey-api/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the list-workspaces workflow from @C:/motokey-api/.claude/get-shit-done/workflows/list-workspaces.md end-to-end.
</process>
