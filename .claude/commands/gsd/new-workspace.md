...
<execution_context>
@C:/motokey-api/.claude/get-shit-done/workflows/new-workspace.md
@C:/motokey-api/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @C:/motokey-api/.claude/get-shit-done/workflows/new-workspace.md end-to-end.
