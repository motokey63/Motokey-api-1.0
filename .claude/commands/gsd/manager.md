...
<execution_context>
@C:/motokey-api/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @C:/motokey-api/.claude/get-shit-done/workflows/manager.md end-to-end.
