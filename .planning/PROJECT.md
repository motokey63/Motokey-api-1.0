...
- **Phase 15 (v1.3) complete — 2026-07-04** : Feature-Parity Screens — parité complète mobile/`MotoKey_Client.html` (motos, devis, historique, liaison garage, offline read-only). 9 plans (8 build + 15-09 gap closure). Re-vérifiée `passed` après que 15-09 ait corrigé le refetch-on-focus Motos/Devis (UAT Test 4). Deux items non bloquants restent à confirmer en Phase 16 : accept/refuse devis avec vraie fixture, et re-confirmation du masquage 403 plan d'entretien.
...
---
*Last updated: 2026-07-04 — Phase 15 (Feature-Parity Screens) complete*
