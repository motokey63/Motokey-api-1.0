...
---
*Last updated: 2026-07-15 — v1.6 Phase 25 (Endpoints Backend km/photos/remplacement compteur/Cloudinary) complete, KM-02/KM-03/CONSO-01/CONSO-03/CLOUD-01 shipped. 1 known gap remains (credentials Cloudinary) ; the initially-reported "dette RBAC transverse" was a test-fixture defect (`sophie@email.com` missing `app_metadata.role`), corrected 2026-07-15 — no real user impact.*
