...
- [ ] **SCHEMA-03**: Chaque colonne découverte est corrélée à la livraison/fonctionnalité qui l'a introduite, via l'historique git (commits, messages, fichiers modifiés à la période probable)
